    ...
    devServer:{
        ...
        proxy: {
            ...
            '//api.map.baidu.com/api?v=2.0': {
                target: 'https://api.map.baidu.com/api?v=2.0&ak=mEgbC3vGaaPnAxDeeHUollEZ',
                // pathRewrite: {'^/api' : ''},
                changeOrigin: true,     // target是域名的话，需要这个参数，
                secure: false,          // 设置支持https协议的代理
            },
            '//apps.bdimg.com/libs/jquery/2.1.1/jquery.min.js': {
                target: 'https://cdnjs.cloudflare.com/ajax/libs/jquery/3.2.1/jquery.min.js',
                // pathRewrite: {'^/api' : ''},
                changeOrigin: true,     // target是域名的话，需要这个参数，
                secure: false,          // 设置支持https协议的代理
            },
            ...
            'http://localhost:8080/build/mapv.js': {
                target: 'https://mapv.baidu.com/build/mapv.js',
                // pathRewrite: {'^/api' : ''},
                changeOrigin: true,     // target是域名的话，需要这个参数，
                secure: false,          // 设置支持https协议的代理
            },
